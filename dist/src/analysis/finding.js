...
export function finding(ruleId, category, severity, confidence, location, summary, recommendation, applicability = 'potential', agentIds = [], context = {}) {
    const rule = ruleDefinition(ruleId);
    if (rule.category !== category)
        throw new Error('AF_RULE_CATEGORY');
